...
if __name__ == "__main__":
    ...
    with get_session() as session:
        ...
        players = [
            get_voting_player(aggregator="majority", **options),
            get_voting_player(aggregator="majority", weights="elo", **options),
            get_voting_player(aggregator="randomized", **options),
            get_voting_player(aggregator="randomized", weights="elo", **options),
            get_voting_player(aggregator="rotating", **options),
        ]
        names = [
            "Most ballot",
