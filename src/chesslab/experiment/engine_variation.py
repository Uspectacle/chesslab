...
if __name__ == "__main__":
    logger.info("Engine variation script")
    folder = Path(__file__).parent / "results/engine_variation"
    ...
    with get_session() as session:
        ...
        players = [
            get_voting_player(crowd_kind="MadChess gaussian", **options),
            get_voting_player(crowd_kind="Stockfish gaussian", **options),
            get_voting_player(crowd_kind="Maia gaussian", **options),
        ]
        names = [
            "MadChess gaussian",
            "Stockfish gaussian",
