...
from chesslab.arena.run_match import get_stockfish_range, run_range
...
if __name__ == "__main__":
    logger.info("Starting Stockfish on MadChess script")
    folder = Path(__file__).parent / "results/stockfish_on_madchess"
