...
% TODO: Add passage for Making the wisdom of crowds efficient
% https://osf.io/preprints/psyarxiv/j9t6p_v1
% Methods to improve the wisdom of crowds by incorporating confidence levels
...
This representation can be altered affecting the move predicted by the LLM.
...
Move quality is unstable and depends on a myriad of parameters (model, prompt with PGN notation, board representation, move history) that can be hard to replicate or interpret.

% TODO: Add paragraph about relevant arxiv work
% https://arxiv.org/pdf/2306.09983
...
% Dynomight systematically evaluated multiple LLM variants, finding that this success can partially be replicated in newer chat oriented model given specific prompts~\cite{Dynomight2024}.
% TODO: Add citation for dynomight.net work
...
% TODO: Add section on Majority Voting in Chess from
% https://link.springer.com/chapter/10.1007/978-3-319-09165-5_17
% Further investigations of 3-member simple majority voting for chess
% Research on ensemble methods in AI for chess
